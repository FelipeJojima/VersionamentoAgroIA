...
from GraphState_antigo import GraphState, monitor_recursos, verify_lock_state, verify_gen_lock, gen_locker, gen_answer_state
from GraphState_antigo import gen_answer_fault, generate_answer_node, generate_answer_without_history, generate_choice, gen_choice_state
from GraphState_antigo import reset_answer, create_model_node, decide_to_generate, resume_historico, grading_node, review_answer_node, verify_history, verify_context
from GraphState_antigo import retrieve_docs_similarity_node, retrieve_docs_similarity_threshold_node, retrieve_docs_mmr_node, gen_prev_hist, review_state
...
def _constroeGrafo(switch_faiss: int, k_docs: int):
    ...
    retrieve_docs_with_args_sim_threshold = partial(retrieve_docs_similarity_threshold_node,vectorstore=vectorstore, k_docs=k_docs, threshold=0.2,fetch_k=50)
