...
final_dir = "/home/felipekenji/IC/IA/RAG/Epagri.ia-main/back/testes/melhores_resultados"

origin_file = "/home/felipekenji/IC/IA/RAG/Epagri.ia-main/back/testes/rouge_l_executions_history.json"
        ...
        if name in basename:
            ...
            match name:
                case "ind_gemma_faiss_v2":
                    resps_ind_gemma_v2.insert((quest_number-1),content)
                case "ind_llama_faiss_v2":
                    resps_ind_llama_v2.insert((quest_number-1),content)
                case "ind_gemma_faiss_v4":
                    resps_ind_gemma_v4.insert((quest_number-1),content)
                case "ind_llama_faiss_v4":
                    resps_ind_llama_v4.insert((quest_number-1),content)
                case "seq_gemma_faiss_v2":
                    resps_seq_gemma_v2.insert((quest_number-1),content)
                case "seq_llama_faiss_v2":
                    resps_seq_llama_v2.insert((quest_number-1), content)
                case "seq_gemma_faiss_v4":
                    resps_seq_gemma_v4.insert((quest_number-1), content)
                case "seq_llama_faiss_v4":
                    print(quest_number)
                    print(resps_seq_llama_v4)
                    resps_seq_llama_v4.insert((quest_number-1),content)
print(melhor_exec_seq_llama_v4)
print(resps_seq_llama_v4)
