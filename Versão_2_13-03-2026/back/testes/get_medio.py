...
media_f1_ind_gemma_v2 = 0.0
media_f1_ind_llama_v2 = 0.0
media_f1_ind_gemma_v4 = 0.0
media_f1_ind_llama_v4 = 0.0
media_f1_seq_gemma_v2 = 0.0
media_f1_seq_llama_v2 = 0.0
media_f1_seq_gemma_v4 = 0.0
media_f1_seq_llama_v4 = 0.0
...
for i in data['executions']:
    if i['model']=="ind_gemma_v2":
        media_f1_ind_gemma_v2 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="ind_llama_v2":
        media_f1_ind_llama_v2 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="ind_gemma_v4":
        media_f1_ind_gemma_v4 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="ind_llama_v4":
        media_f1_ind_llama_v4 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="seq_gemma_v2":
        media_f1_seq_gemma_v2 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="seq_llama_v2":
        media_f1_seq_llama_v2 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="seq_gemma_v4":
        media_f1_seq_gemma_v4 += (i['rouge_l_f1']/MAX_EXECS)

    elif i['model']=="seq_llama_v4":
        media_f1_seq_llama_v4 += (i['rouge_l_f1']/MAX_EXECS)


media_mais_proxima_f1_ind_gemma_v2 = 0.0
media_mais_proxima_f1_ind_llama_v2 = 0.0
media_mais_proxima_f1_ind_gemma_v4 = 0.0
media_mais_proxima_f1_ind_llama_v4 = 0.0
media_mais_proxima_f1_seq_gemma_v2 = 0.0
media_mais_proxima_f1_seq_llama_v2 = 0.0
media_mais_proxima_f1_seq_gemma_v4 = 0.0
media_mais_proxima_f1_seq_llama_v4 = 0.0

for i in data['executions']:
    if i['model']=="ind_gemma_v2":
        if (abs(media_mais_proxima_f1_ind_gemma_v2-media_f1_ind_gemma_v2)) > (abs(i['rouge_l_f1']-media_f1_ind_gemma_v2)):
            melhor_exec_ind_gemma_v2 = i['execution_number']
            media_mais_proxima_f1_ind_gemma_v2 = i['rouge_l_f1']

    elif i['model']=="ind_llama_v2":
        if (abs(media_mais_proxima_f1_ind_llama_v2-media_f1_ind_llama_v2)) > (abs(i['rouge_l_f1']-media_f1_ind_llama_v2)):
            melhor_exec_ind_llama_v2 = i['execution_number']
            media_mais_proxima_f1_ind_llama_v2 = i['rouge_l_f1']

    elif i['model']=="ind_gemma_v4":
        if (abs(media_mais_proxima_f1_ind_gemma_v4-media_f1_ind_gemma_v4)) > (abs(i['rouge_l_f1']-media_f1_ind_gemma_v4)):
            melhor_exec_ind_gemma_v4 = i['execution_number']
            media_mais_proxima_f1_ind_gemma_v4 = i['rouge_l_f1']

    elif i['model']=="ind_llama_v4":
        if (abs(media_mais_proxima_f1_ind_llama_v4-media_f1_ind_llama_v4)) > (abs(i['rouge_l_f1']-media_f1_ind_llama_v4)):
            melhor_exec_ind_llama_v4 = i['execution_number']
            media_mais_proxima_f1_ind_llama_v4 = i['rouge_l_f1']

    elif i['model']=="seq_gemma_v2":
        if (abs(media_mais_proxima_f1_seq_gemma_v2-media_f1_seq_gemma_v2)) > (abs(i['rouge_l_f1']-media_f1_seq_gemma_v2)):
            melhor_exec_seq_gemma_v2 = i['execution_number']
            media_mais_proxima_f1_seq_gemma_v2 = i['rouge_l_f1']

    elif i['model']=="seq_llama_v2":
        if (abs(media_mais_proxima_f1_seq_llama_v2-media_f1_seq_llama_v2)) > (abs(i['rouge_l_f1']-media_f1_seq_llama_v2)):
            melhor_exec_seq_llama_v2 = i['execution_number']
            media_mais_proxima_f1_seq_llama_v2 = i['rouge_l_f1']

    elif i['model']=="seq_gemma_v4":
        if (abs(media_mais_proxima_f1_seq_gemma_v4-media_f1_seq_gemma_v4)) > (abs(i['rouge_l_f1']-media_f1_seq_gemma_v4)):
            melhor_exec_seq_gemma_v4 = i['execution_number']
            media_mais_proxima_f1_seq_gemma_v4 = i['rouge_l_f1']

    elif i['model']=="seq_llama_v4":
        if (abs(media_mais_proxima_f1_seq_llama_v4-media_f1_seq_llama_v4)) > (abs(i['rouge_l_f1']-media_f1_seq_llama_v4)):
            melhor_exec_seq_llama_v4 = i['execution_number']
            media_mais_proxima_f1_seq_llama_v4 = i['rouge_l_f1']
