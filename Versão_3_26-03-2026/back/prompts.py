...
PROMPT_ANSWER_FAULT = """
Você é um assistente para responder perguntas. Você não encontrou respostas nos documentos trazidos pelo site EpagriTEC. Elabore uma resposta para a pergunta abaixo dizendo que não conseguiu responder e recomende o material da EpagriTEC para consulta (site da EpagriTec = https://sistemas.epagri.sc.gov.br/sedimob/consulta.action?subFuncao=epagriTec, para referenciar use a máscara "EpagriTEC").
