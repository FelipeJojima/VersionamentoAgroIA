...
from back.GraphState import GraphState, verify_lock_state, verify_gen_lock, gen_locker, gen_answer_state
from back.GraphState import gen_answer_fault, generate_answer_node, generate_answer_without_history, generate_choice, gen_choice_state
from back.GraphState import reset_answer, create_model_node, decide_to_generate, resume_historico, grading_node, review_answer_node, verify_history, verify_context
from back.GraphState import retrieve_docs_similarity_node, retrieve_docs_similarity_threshold_node, retrieve_docs_mmr_node, gen_prev_hist, review_state
...
def _constroeGrafo(switch_faiss: int, k_docs: int):
    ...
    match switch_faiss:
        case 1:
            FAISS_PATH = "/home/admin/Projects/Epagri_ia/back/bd/faiss_v1" 
            EMBEDDING_MODEL = "sentence-transformers/all-mpnet-base-v2"
        case 2:
            FAISS_PATH = "/home/admin/Projects/Epagri_ia/back/bd/faiss_index_com_chunking,pior_que_o_outro-mpnet-base-v2" 
            EMBEDDING_MODEL = "sentence-transformers/all-mpnet-base-v2"
        case 3:
            FAISS_PATH = "/home/admin/Projects/Epagri_ia/back/bd/faiss_index_sem_chunking-mpnet-base-v2" 
            EMBEDDING_MODEL = "sentence-transformers/all-mpnet-base-v2"
        case 4:
            EMBEDDING_MODEL = "intfloat/multilingual-e5-large" 
            FAISS_PATH = "/home/admin/Projects/Epagri_ia/back/bd/faiss_index_com_chunking_intfloatmultilingual-e5-large"  
...
def search(pergunta: str, thread_id: str, model:int):
    ...
    match model:
        case 1: 
            DEFAULT_LLM_MODEL = "mygemma3:12b"
        case 2:
    ...
    return {"answer": final_answer, "sources": source, "history": history, "search_method": s_method, "question": pergunta}
...
# initialize_model(4,25) 
# thread_id=str(uuid.uuid4())
# resp = search(pergunta=perguntas[0], thread_id=thread_id, model=2)
